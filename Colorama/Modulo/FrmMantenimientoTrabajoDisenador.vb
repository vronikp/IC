  ...
  Sub llenar_datos()
    ...
    If mTrabajo IsNot Nothing Then
      ...
      If mTrabajo.UltimoTrabajoLog IsNot Nothing Then
        ...
        End If
        If Not mTrabajo.UltimoTrabajoLog.Pardet_AccionTrabajo = Enumerados.enumEstadoSobre.TomadoporEditores Then
          Dim _trabajolog As New TrabajoLog(mTrabajo, True)
          _trabajolog.PardetAccionTrabajo = New WWTSParametroDet(Sistema.OperadorDatos, Enumerados.EnumParametros.EstadoSobre, Enumerados.enumEstadoSobre.TomadoporEditores)
